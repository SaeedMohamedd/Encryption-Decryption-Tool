...
public class PlayFair {
    ...
    public String encrypt_playfair(String Source)
    {
    ...
    public String decrypt_playfair(String Code)
    {
    ...
    public static void main(String[] args)
    {
       /* 
        ...
        {
            System.out.println("Encryption: " + x.encrypt_playfair(key_input));
            System.out.println("Decryption: "
                    + x.decrypt_playfair(x.encrypt_playfair(key_input)));
        }
        else
        {
